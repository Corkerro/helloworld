(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        buttons.forEach((function(button) {
            button.addEventListener("mouseenter", (function(e) {
                var parentOffset = button.getBoundingClientRect(), relX = e.pageX - parentOffset.left - window.scrollX, relY = e.pageY - parentOffset.top - window.scrollY;
    ...
    if (ScrollTrigger.isTouch !== 1) ScrollSmoother.create({
        wrapper: ".wrapper",
        content: ".content",
        smooth: 2,
        effects: true
    });
    if (screenWidth >= 1020) gsap.fromTo(".header__logo", {
        scale: 1,
        y: 0
    }, {
        scale: .5,
